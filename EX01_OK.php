...
// ------------------------------------------------------------------------------
// creamos una variable $x ya que no estaba definida
$x = 'Cositas';

// ------------------------------------------------------------------------------
// creamos una variable dades porque no existe 
$dades = 'Cositas 2';
...
// ------------------------------------------------------------------------------
// creamos la variable $base ya que no existe
$base = 19.99;
...
// ------------------------------------------------------------------------------
// la variable missatge existe fuera de la función, por lo que se la pasamos dentro
...
// ------------------------------------------------------------------------------
// usamos la funcion sin el return para visualizar
    echo "<br>";
    saluda($missatge);

// ------------------------------------------------------------------------------
// recogemos la salida de la funcion para poder imprimirla

    echo "<br>";
    $returnsaluda = saluda($missatge);
    echo "<br>";
    echo $returnsaluda; // no existe
